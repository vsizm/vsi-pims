...
export async function POST(request) {
  try {
    ...
    // The legacy participant columns remain the report's summary fields. The full planned/reached
    // breakdown is preserved in the JSON attachments metadata until the participant-detail columns
    // are added to the reporting schema.
