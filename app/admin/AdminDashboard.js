...
export default function AdminDashboard({ active = 'Dashboard', title = 'Administration Dashboard', subtitle = 'Management overview of VSI activity reporting, finance and MEAL performance.' }) {
  ...
  return <div className="admin-app"><Sidebar active={active} /><main className="admin-main">
    ...
    .admin-app{min-height:100vh;background:#f4f7fa;color:#17212b;display:flex;overflow-x:hidden;box-sizing:border-box}.admin-app *{box-sizing:border-box}.admin-sidebar{position:sticky;top:0;height:100vh;width:264px;min-width:264px;max-width:264px;flex:0 0 264px;overflow:hidden;background:linear-gradient(180deg,#003566 0%,#094074 58%,#082f52 100%);color:#fff;padding:22px 16px;display:flex;flex-direction:column;box-shadow:8px 0 24px rgba(0,53,102,.12)}.side-brand{width:100%;min-width:0;display:flex;align-items:center;gap:10px;padding:4px 8px 25px;border-bottom:1px solid rgba(255,255,255,.14)}.side-brand img{display:block;width:48px!important;height:32px!important;min-width:48px;min-height:32px;max-width:48px!important;max-height:32px!important;object-fit:contain;object-position:center;flex:0 0 48px}.side-brand>div{min-width:0;overflow:hidden}.side-brand strong{display:block;font-size:16px;line-height:1.2;letter-spacing:.07em;white-space:nowrap}.side-brand small{display:block;font-size:9px;line-height:1.2;letter-spacing:.13em;color:#ffd60a;margin-top:3px;font-weight:900;white-space:nowrap}.side-label{font-size:10px;font-weight:900;letter-spacing:.16em;color:rgba(255,255,255,.58);padding:22px 10px 8px}.side-label.intelligence{padding-top:25px}.admin-sidebar nav{display:flex;flex-direction:column;gap:4px;min-width:0}.admin-sidebar nav a{min-width:0;color:rgba(255,255,255,.84);text-decoration:none;padding:11px 12px;border-radius:10px;font-size:13px;font-weight:800;display:flex;align-items:center;gap:10px;white-space:nowrap;overflow:hidden;transition:.15s}.admin-sidebar nav a:hover{background:rgba(255,255,255,.09);color:#fff;transform:translateX(2px)}.admin-sidebar nav a.active{background:#ffc300;color:#003566;box-shadow:0 6px 16px rgba(0,0,0,.12)}.nav-dot{width:7px;height:7px;border-radius:50%;background:#3c6997;flex:0 0 7px}.intel-dot{background:#ffd60a}.active .nav-dot{background:#003566}.side-note{font-size:11px;line-height:1.6;color:rgba(255,255,255,.68);padding:18px 10px 0;overflow:hidden}.back-report{margin-top:auto;text-decoration:none;color:#003566;background:#ffd60a;border-radius:10px;padding:11px 12px;text-align:center;font-size:12px;font-weight:900;white-space:nowrap;overflow:hidden}.admin-main{min-width:0;max-width:100%;flex:1;padding:30px clamp(20px,4vw,46px) 60px;overflow:hidden}.admin-header{display:flex;justify-content:space-between;align-items:flex-start;gap:20px;margin-bottom:28px;min-width:0}.admin-header>div{min-width:0}.admin-kicker{font-size:11px;letter-spacing:.14em;color:#3c6997;font-weight:900;margin-bottom:8px}.admin-header h1{margin:0;color:#003566;font-size:clamp(27px,3vw,38px);letter-spacing:-.03em}.admin-header p{margin:8px 0 0;color:#65717d;max-width:760px;line-height:1.6;font-size:14px}.header-action,.panel-head a{white-space:nowrap;text-decoration:none;color:#094074;font-size:11px;font-weight:900}.header-action{border:1px solid #dfe5ea;background:#fff;border-radius:10px;padding:11px 14px;font-size:12px}.stat-grid{display:grid;grid-template-columns:repeat(4,minmax(0,1fr));gap:16px;margin-bottom:18px;min-width:0}.stat-link{display:block;min-width:0;text-decoration:none;color:inherit}.stat-card{min-width:0;background:#fff;border:1px solid #dfe5ea;border-radius:14px;padding:18px;box-shadow:0 4px 18px rgba(0,53,102,.045);border-top:4px solid #3c6997;transition:transform .15s,box-shadow .15s}.stat-link:hover .stat-card{transform:translateY(-2px);box-shadow:0 8px 24px rgba(0,53,102,.09)}.stat-card.yellow{border-top-color:#ffc300}.stat-card.green{border-top-color:#2e7d52}.stat-card.navy{border-top-color:#003566}.stat-card span{display:block;font-size:10px;letter-spacing:.13em;color:#65717d;font-weight:900}.stat-card strong{display:block;color:#003566;font-size:29px;margin:7px 0 3px}.stat-card small{color:#65717d;font-size:11px}.dashboard-grid{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:18px;min-width:0}.dash-panel{background:#fff;border:1px solid #dfe5ea;border-radius:15px;padding:22px;box-shadow:0 4px 18px rgba(0,53,102,.045);min-width:0;overflow:hidden}.dash-panel.wide{grid-column:span 2}.hero-panel{border-top:4px solid #003566}.panel-head{display:flex;justify-content:space-between;gap:15px;align-items:flex-start;margin-bottom:20px;min-width:0}.panel-head>div{min-width:0}.panel-head span{font-size:10px;letter-spacing:.13em;color:#3c6997;font-weight:900}.panel-head h2{margin:5px 0 0;color:#003566;font-size:18px}.metric-grid{display:grid;grid-template-columns:repeat(4,minmax(0,1fr));gap:12px;min-width:0}.metric-grid>div{background:#f6f9fb;border-radius:10px;padding:14px;min-width:0}.metric-grid small{display:block;color:#65717d;font-size:11px}.metric-grid strong{display:block;color:#003566;font-size:24px;margin:5px 0}.metric-grid span{color:#65717d;font-size:10px}.big-number{font-size:31px;color:#003566;font-weight:900;margin:5px 0 16px}.bar{height:9px;background:#e9eef2;border-radius:99px;overflow:hidden}.bar i{display:block;height:100%;background:#ffc300;border-radius:99px}.bar-label{display:flex;justify-content:space-between;margin:8px 0 18px;font-size:11px;color:#65717d}.bar-label strong{color:#003566}.finance-row{display:flex;justify-content:space-between;gap:12px;border-top:1px solid #dfe5ea;padding:10px 0;font-size:12px;color:#65717d}.finance-row strong{color:#003566}.health-ring{width:118px;height:118px;border-radius:50%;margin:3px auto 15px;background:conic-gradient(#ffc300 ${stats.health}%,#e8edf1 0);display:grid;place-content:center;text-align:center;position:relative}.health-ring:after{content:'';position:absolute;inset:9px;background:#fff;border-radius:50%}.health-ring strong,.health-ring span{position:relative;z-index:1}.health-ring strong{font-size:26px;color:#003566}.health-ring span{font-size:9px;color:#65717d;text-transform:uppercase;letter-spacing:.08em}.panel-copy{text-align:center;color:#65717d;font-size:12px;line-height:1.55;max-width:330px;margin:auto}.programme-list{display:flex;flex-direction:column;min-width:0}.programme-row{display:flex;justify-content:space-between;gap:20px;padding:13px 0;border-top:1px solid #dfe5ea;min-width:0}.programme-row>div:first-child{min-width:0}.programme-row strong{display:block;color:#003566;font-size:13px}.programme-row small{display:block;color:#65717d;font-size:10px;margin-top:3px}.programme-finance{text-align:right;flex:0 0 auto}.empty,.admin-notice,.admin-error{padding:16px;border-radius:10px;font-size:13px}.empty,.admin-notice{background:#f5f8fa;color:#65717d}.admin-error{background:#fff0f0;border:1px solid #efb6b6;color:#9a2525;margin-bottom:18px}@media(max-width:1000px){.admin-sidebar{width:220px;min-width:220px;max-width:220px;flex-basis:220px}.stat-grid{grid-template-columns:repeat(2,minmax(0,1fr))}.metric-grid{grid-template-columns:repeat(2,minmax(0,1fr))}}@media(max-width:760px){.admin-app{display:block;overflow-x:hidden}.admin-sidebar{position:relative;width:100%;min-width:0;max-width:none;height:auto;padding:12px;overflow:visible}.side-brand{padding-bottom:12px}.admin-sidebar nav{display:grid;grid-template-columns:repeat(2,minmax(0,1fr))}.side-label,.side-note,.back-report{display:none}.admin-main{padding:22px 14px 40px;overflow:visible}.admin-header{display:block}.header-action{display:inline-block;margin-top:15px}.dashboard-grid{grid-template-columns:1fr}.dash-panel.wide{grid-column:auto}.stat-grid{grid-template-columns:repeat(2,minmax(0,1fr))}.metric-grid{grid-template-columns:repeat(2,minmax(0,1fr))}}@media(max-width:430px){.stat-grid,.metric-grid{grid-template-columns:1fr}.admin-sidebar nav{grid-template-columns:1fr}.panel-head{display:block}.panel-head a{display:inline-block;margin-top:8px}.programme-row{display:block}.programme-finance{text-align:left;margin-top:8px}.admin-header h1{font-size:28px}}
  `}</style></div>;
}
