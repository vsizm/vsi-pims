  ...
  useEffect(() => {
    ...
    if (!document.getElementById(styleId)) {
      ...
      style.textContent = `
        ...
        .vsi-workspace-header .vsi-workspace-copy{min-width:0;display:flex;flex-direction:column;gap:4px;flex:1;align-items:flex-start;text-align:left}
        .vsi-workspace-header .vsi-workspace-copy .kicker{margin:0;color:#CBD5E1;font-size:10px;font-weight:800;letter-spacing:.11em;text-transform:uppercase;line-height:1.2;text-align:left}
        .vsi-workspace-header .vsi-workspace-copy h1{margin:0!important;color:#fff!important;font-size:21px!important;font-weight:800!important;letter-spacing:-.02em;line-height:1.2;text-align:left}
        .vsi-workspace-header .vsi-workspace-copy p{margin:0!important;color:#CBD5E1!important;font-size:12px!important;font-weight:400;line-height:1.45;text-align:left}
